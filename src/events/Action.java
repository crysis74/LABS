...
public class Action implements Event {
    ...
    public String tellStory() {
            ...
            switch (action) {
                case JUMP:
                    return "Герой " + heroName + " решил, что ему скучно, поэтому он прыгнул.";
                case RUN:
                    return "Герой " + heroName + " побежал в поисках пищи, но не смог  ее найти.";
                case PUT:
                    return "Герой " + heroName + " решил положить свои вещи именно здесь.";
                case WATCH:
                    return "Герой " + heroName + " решил оглядеться.";
                default:
                    return "...";
            }
    }
